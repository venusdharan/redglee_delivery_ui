        ...
        <v-expansion-panels class="mb-6"-->
            ...
            <v-expansion-panel-content>
                <v-row>
                    ...
                    <vue-tel-input v-model="phone" required autocomplete="off" ></vue-tel-input>
                ...
                <v-row>
                      ...
                      <v-col>
                        ...
                        <v-datetime-picker  :datePickerProps='{color:"primary"}' label="Pickup before" v-model="datetime" >
                ...
                <v-row>
                    ...
                    <v-col>
                       ...
                       <v-col>
                        ...
                        <gmap-autocomplete class="form-control" style="width: 100%" v-model="address"  @place_changed="setPlace">
    ...
    >
      ...
      <v-card>
        <v-card-title class="headline">
           Error pickup place out side geofence
        </v-card-title>
...
export default {
    ...
    watch: {
        ...
        focus_lat_lng(n,o){
        if(n == null ){ return; }
        if(this.open_pickup_item == this.index){
